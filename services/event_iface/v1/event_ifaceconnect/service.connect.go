...
const (
	...
	PushServiceName = "event_iface.v1.PushService"
)
...
const (
	...
	PushServicePushProcedure = "/event_iface.v1.PushService/Push"
)
...
// PushServiceClient is a client for the event_iface.v1.PushService service.
type PushServiceClient interface {
	Push(context.Context, *connect.Request[v1.PushRequest]) (*connect.Response[v1.PushResponse], error)
}

// NewPushServiceClient constructs a client for the event_iface.v1.PushService service. By default,
...
func NewPushServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PushServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	pushServiceMethods := v1.File_event_iface_v1_service_proto.Services().ByName("PushService").Methods()
...
// Push calls event_iface.v1.PushService.Push.
...
// PushServiceHandler is an implementation of the event_iface.v1.PushService service.
...
func NewPushServiceHandler(svc PushServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/event_iface.v1.PushService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPushServiceHandler) Push(context.Context, *connect.Request[v1.PushRequest]) (*connect.Response[v1.PushResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("event_iface.v1.PushService.Push is not implemented"))
}
