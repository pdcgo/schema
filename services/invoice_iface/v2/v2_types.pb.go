...
const (
	...
	BalanceChangeType_BALANCE_CHANGE_TYPE_STOCK_FOUND_BACK BalanceChangeType = 7
)
...
var (
	BalanceChangeType_name = map[int32]string{
		...
		7: "BALANCE_CHANGE_TYPE_STOCK_FOUND_BACK",
	}
	BalanceChangeType_value = map[string]int32{
		...
		"BALANCE_CHANGE_TYPE_STOCK_FOUND_BACK": 7,
	}
)
...
const file_invoice_iface_v2_v2_types_proto_rawDesc = "" +
	...
	"\x0eSORT_TYPE_DESC\x10\x02*\xbb\x02\n" +
	...
	"!BALANCE_CHANGE_TYPE_STOCK_PROBLEM\x10\x06\x12(\n" +
	"$BALANCE_CHANGE_TYPE_STOCK_FOUND_BACK\x10\a*Y\n" +
