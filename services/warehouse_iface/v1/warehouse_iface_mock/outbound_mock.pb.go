...
func (m *MockOutboundService) OutboundDetailIDs(ctx context.Context, req *connect.Request[v1.OutboundDetailIDsRequest]) (*connect.Response[v1.OutboundDetailIDsResponse], error) {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "OutboundDetailIDs", ctx, req)
    ret0, _ := ret[0].(*connect.Response[v1.OutboundDetailIDsResponse])
    ret1, _ := ret[1].(error)
    return ret0, ret1
}

func (mr *MockOutboundServiceMockRecorder) OutboundDetailIDs(ctx, req interface{}) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OutboundDetailIDs", reflect.TypeOf((*MockOutboundService)(nil).OutboundDetailIDs), ctx, req)
}

func (m *MockOutboundServiceClient) OutboundDetailIDs(ctx context.Context, req *connect.Request[v1.OutboundDetailIDsRequest]) (*connect.Response[v1.OutboundDetailIDsResponse], error) {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "OutboundDetailIDs", ctx, req)
    ret0, _ := ret[0].(*connect.Response[v1.OutboundDetailIDsResponse])
    ret1, _ := ret[1].(error)
...
func (mr *MockOutboundServiceClientMockRecorder) OutboundDetailIDs(ctx, req interface{}) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OutboundDetailIDs", reflect.TypeOf((*MockOutboundService)(nil).OutboundDetailIDs), ctx, req)
}
...
func (m *MockOutboundService) OutboundByProduct(ctx context.Context, req *connect.Request[v1.OutboundByProductRequest]) (*connect.Response[v1.OutboundByProductResponse], error) {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "OutboundByProduct", ctx, req)
    ret0, _ := ret[0].(*connect.Response[v1.OutboundByProductResponse])
    ret1, _ := ret[1].(error)
    return ret0, ret1
}

func (mr *MockOutboundServiceMockRecorder) OutboundByProduct(ctx, req interface{}) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OutboundByProduct", reflect.TypeOf((*MockOutboundService)(nil).OutboundByProduct), ctx, req)
}

func (m *MockOutboundServiceClient) OutboundByProduct(ctx context.Context, req *connect.Request[v1.OutboundByProductRequest]) (*connect.Response[v1.OutboundByProductResponse], error) {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "OutboundByProduct", ctx, req)
    ret0, _ := ret[0].(*connect.Response[v1.OutboundByProductResponse])
    ret1, _ := ret[1].(error)
...
func (mr *MockOutboundServiceClientMockRecorder) OutboundByProduct(ctx, req interface{}) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OutboundByProduct", reflect.TypeOf((*MockOutboundService)(nil).OutboundByProduct), ctx, req)
}
